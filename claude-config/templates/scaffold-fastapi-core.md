# Scaffold FastAPI Core — File Templates

Reference loaded by `/scaffold-project` for Step 3 (file contents). All file contents below are the canonical FastAPI layered-architecture scaffold.
