...
Frontmatter is **manually-edited only**. Pulse never writes to this file
— pulse owns per-host sidecars at `<vault>/Projects/_pulse/<project>--<host>.md`
exclusively (Codex Finding 3 fix; see §6 single-writer-per-host design).
